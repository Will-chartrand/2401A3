...
// The quantity of evidence currently stored in the new array is always zero, andthe elements
// array must be dynamically allocated to hold the number of elements indicated by the capacity
